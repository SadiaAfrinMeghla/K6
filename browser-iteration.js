...
// 1️⃣ Shared Iterations: Distributes a fixed number of iterations across multiple VUs
/*
export const options = {
    scenarios: {
        browser_test: {
...
// 2️⃣ Constant VUs: Runs a fixed number of users for a specific duration
/*
export const options = {
    scenarios: {
        browser_test: {
...
// 3️⃣ Ramping VUs: Simulates increasing and decreasing traffic over time
/*
export const options = {
    scenarios: {
        browser_test: {
...
// 4️⃣ Variable Arrival Rate: Controls the rate at which new VUs start
/*
export const options = {
    scenarios: {
        browser_test: {
